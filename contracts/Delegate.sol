...
contract Delegate {
  bytes32 private constant delegateRegistryPosition = keccak256("org.opencoverage.delegate.registry");
  bytes32 private constant delegateKeyPosition = keccak256("org.opencoverage.delegate.key");
